...
import wad.test.domain.orderProduct.OrderProductRepository;
...
import static wad.test.domain.product.ProductType.*;

@ActiveProfiles("test")
@SpringBootTest
@Transactional // 문제가 있을 수도 있음! 팀원 내에서 이를 다 인지하고 있어야한다.
